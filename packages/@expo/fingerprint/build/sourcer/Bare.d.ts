...
export declare function getBareMacosSourcesAsync(projectRoot: string, options: NormalizedOptions): Promise<HashSource[]>;
...
export declare function getCoreAutolinkingSourcesFromExpoMacos(projectRoot: string, options: NormalizedOptions, useRNCoreAutolinkingFromExpo?: boolean): Promise<HashSource[]>;
